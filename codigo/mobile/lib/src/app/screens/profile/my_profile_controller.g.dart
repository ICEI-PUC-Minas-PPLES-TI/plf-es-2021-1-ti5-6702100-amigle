...
mixin _$MyProfileController on _MyProfileControllerBase, Store {
  ...
  Computed<bool> _$verifyAgeComputed;
  ...
  @override
  String get errorAge {
    _$errorAgeAtom.context.enforceReadPolicy(_$errorAgeAtom);
    _$errorAgeAtom.reportObserved();
    return super.errorAge;
  }

  @override
  set errorAge(String value) {
    _$errorAgeAtom.context.conditionallyRunInAction(() {
      super.errorAge = value;
      _$errorAgeAtom.reportChanged();
